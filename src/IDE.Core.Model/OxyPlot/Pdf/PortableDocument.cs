...
namespace OxyPlot
{
    ...
    public class PortableDocument
    {
        ...
        /// <summary>
        /// Draws the text line at the specified coordinate.
        /// </summary>
        ...
        public void DrawText(double x, double y, string text)
        {
            ...
            var txtline = EncodeString(text, this.currentFont.Encoding);
            txtline = EscapeString(txtline);
            ...
            this.AppendLine("{0} Tj", txtline); // Show text string
                                                //  y -= height;
