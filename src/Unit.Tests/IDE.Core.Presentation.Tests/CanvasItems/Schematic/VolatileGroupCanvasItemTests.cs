...
{
    public class VolatileGroupCanvasItemTests
    {
        [Theory]
        [InlineData(0, 0, 5, 10, 0, 0, 5, 10)]
        ...
        {
            var item = new VolatileGroupCanvasItem
            {
                X = x,
                Y = y,
                DisplayWidth = width,
        ...
        [Theory]
        //translate only
        [InlineData(0, 0, 5, 10, 1, 1, 0, 1, 1, 0, 0)]
