...
public class NetLabelPlacementToolTests : PlacementToolTest
{
    public NetLabelPlacementToolTests()
    {
        ...
        var canvasItemType = typeof(NetLabelCanvasItem);
        placementTool =new NetLabelPlacementTool();
    ...
    public void PlacementStarted_MouseMoves()
    {
        ...
        var item = placementTool.CanvasItem as NetLabelCanvasItem;
