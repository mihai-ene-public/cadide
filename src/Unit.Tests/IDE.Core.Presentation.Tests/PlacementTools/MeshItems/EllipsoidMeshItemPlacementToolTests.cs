...
public class EllipsoidMeshItemPlacementToolTests : PlacementToolTest
{
    public EllipsoidMeshItemPlacementToolTests()
    {
        ...
        var canvasItemType = typeof(EllipsoidMeshItem);
        placementTool = new EllipsoidMeshItemPlacementTool();
    ...
    public void PlacementStarted_MouseMoves()
    {
        ...
        var item = placementTool.CanvasItem as EllipsoidMeshItem;
