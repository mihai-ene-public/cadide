...
public class CylinderMeshItemPlacementToolTests : PlacementToolTest
{
    public CylinderMeshItemPlacementToolTests()
    {
    ...
    public void PlacementStarted_MouseMoves()
    {
        ...
        var item = placementTool.CanvasItem as CylinderMeshItem;
