...
public class SphereMeshItemPlacementToolTests : PlacementToolTest
{
    public SphereMeshItemPlacementToolTests()
    {
        ...
        var canvasItemType = typeof(SphereMeshItem);
        placementTool = new SphereMeshItemPlacementTool();
    ...
    public void PlacementStarted_MouseMoves()
    {
        ...
        var item = placementTool.CanvasItem as SphereMeshItem;
