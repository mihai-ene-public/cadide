...
{
    public class PinPlacementToolTests : PlacementToolTest
    {
        public PinPlacementToolTests()
        {
            ...
            var canvasItemType = typeof(PinCanvasItem);
            placementTool = new PinPlacementTool();
        ...
        public void PlacementStarted_MouseMoves()
        {
            ...
            var item = placementTool.CanvasItem as IPinCanvasItem;
