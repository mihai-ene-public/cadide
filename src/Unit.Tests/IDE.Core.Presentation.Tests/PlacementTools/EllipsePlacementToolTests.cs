...
{
    public class EllipsePlacementToolTests : PlacementToolTest
    {
        public EllipsePlacementToolTests()
        {
            ...
            var canvasItemType = typeof(EllipseCanvasItem);
            placementTool = new EllipsePlacementTool();
        ...
        public void PlacementReady_MouseMoves()
        {
            ...
            var item = placementTool.CanvasItem as IEllipseCanvasItem;
        ...
        public void PlacementStarted_MouseClick()
        {
            ...
            var clonedItem = placementTool.CanvasItem as IEllipseCanvasItem;
