...
namespace STPLoader.Implementation.Parser
{
    ...
    public class StpParser : IParser
    {
        ...
        private StpHeader ParseHeader(Stream headerStream)
        {
            ...
            header.Description = new FileDescription(new List<string> { "dummy" }, "dummy");//new FileDescription(ParseHelper.ParseList(descriptionList[0]), descriptionList[1]);
