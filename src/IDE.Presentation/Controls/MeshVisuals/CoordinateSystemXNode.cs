...
{
    public class CoordinateSystemXNode : ScreenSpacedNode
    {
        ...
        private void UpdateModel()
        {
            ...
            builder.AddArrow(Vector3.Zero, new Vector3(0, 0, zDirection * arrowSize), arrowWidth, arrowHead, 8);
        ...
        protected void UpdateAxisColor(Geometry3D mesh, int which, Color4 color, string label, Color4 labelColor)
        {
            ...
            switch (which)
            {
                ...
                case 2:
                    labelText.TextInfo[which] = new TextInfo(label, new Vector3(0, 0, zDirection * (arrowSize + 1.5f))) { Foreground = labelColor, Scale = 0.5f };
                    break;
            }
