namespace IDE.Core.Behaviors
{
	...
	public static class DropFileCommand
	{
		...
		static readonly DependencyProperty DropCommandProperty = DependencyProperty.RegisterAttached(
				"DropCommand",
				typeof(ICommand),
		...
		/// <param name="d"></param>
		/// <param name="e"></param>
		static void OnDropCommandChange(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
		...
		/// <param name="e"></param>
		static void UIElement_Drop(object sender, DragEventArgs e)
		{
