    ...
    public class MergeStyleBehaviour
    {
        ...
        private static void OnAutoMergeStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            try
            {
                ...
                {
                    // var type = d.GetType();
                    control.SetResourceReference(BaseOnStyleProperty, d.GetType());
                }
                else
                {
                                                 ...
                                                 DependencyPropertyChangedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var sInfo = string.Format(CultureInfo.CurrentCulture, "newStyle: {0}", (newStyle != null ? newStyle.TargetType.FullName : "(null)"));
