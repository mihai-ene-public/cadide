...
public class MeasureDistance2DAdorner : Adorner
{
        ...
        : base(canvas)
    {
        ...
        canvasModel = designerCanvas.DataContext as ICanvasViewModel;

        //a copy of grid unit
        var cg = canvasModel.CanvasGrid;
        gridUnit = (AbstractUnit)Activator.CreateInstance(cg.CurrentUnit.GetType());
    }
