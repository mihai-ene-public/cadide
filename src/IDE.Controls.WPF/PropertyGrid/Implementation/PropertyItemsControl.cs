...
public class PropertyItemsControl : ItemsControl
{
    ...
    private void RaisePreparePropertyItemEvent(PropertyItem propertyItem, object item)
    {
    ...
    private void RaiseClearPropertyItemEvent(PropertyItem propertyItem, object item)
    {
    ...
    protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
    {
        ...
        this.RaisePreparePropertyItemEvent((PropertyItem)element, item);
    }

    protected override void ClearContainerForItemOverride(DependencyObject element, object item)
    {
        this.RaiseClearPropertyItemEvent((PropertyItem)element, item);
