...
namespace Xceed.Wpf.Toolkit.Media.Animation
{
  ...
  public struct AnimationRate
  {
    ...
    public AnimationRate( TimeSpan duration )
    {
      ...
      {
        throw new ArgumentException(  ErrorMessages.NegativeTimeSpanNotSupported) ;
      }
      _speed = 0d;
    ...
    public AnimationRate( double speed )
    {
      ...
      {
        throw new ArgumentException(  ErrorMessages.NegativeSpeedNotSupported  );
      }
      _duration = 0;
      _speed = speed;
    ...
    public TimeSpan Duration
    {
      get
      {
        ...
        throw new InvalidOperationException( 
          string.Format(
             ErrorMessages.InvalidRatePropertyAccessed ,
            "Duration", 
            this, 
            "Speed" ) );
      }
