...
namespace Xceed.Wpf.Toolkit.Core
{
  internal static class ErrorMessages
  {
    ...
    public const string ViewStackCannotBeManipulatedNow = "ViewStackCannotBeManipulatedNow";
        ...
        public const string SuppliedValueWasNotBool = "SuppliedValueWasNotBool";
    public const string SuppliedValueWasNotVisibility = "Error converting from Visibility value to bool value. Supplied value was not of type Visibility.";
