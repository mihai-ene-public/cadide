  ...
  public class VisibilityToBoolConverter : IValueConverter
  {
    ...
    private object VisibilityToBool( object value )
    {
      if( !( value is Visibility ) )
        throw new InvalidOperationException( ErrorMessages.SuppliedValueWasNotVisibility );
    ...
    {
      if( !( value is bool ) )
        throw new InvalidOperationException( ErrorMessages.SuppliedValueWasNotBool );
