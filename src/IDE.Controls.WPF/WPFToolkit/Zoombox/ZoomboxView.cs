...
namespace Xceed.Wpf.Toolkit.Zoombox
{
  ...
  public class ZoomboxView
  {
    ...
    public Point Position
    {
      get
      {
        if( this.ViewKind != ZoomboxViewKind.Absolute )
          throw new InvalidOperationException( ErrorMessages.PositionOnlyAccessibleOnAbsolute );
      ...
      set
      {
        if( this.ViewKind != ZoomboxViewKind.Absolute && this.ViewKind != ZoomboxViewKind.Empty )
          throw new InvalidOperationException( String.Format( ErrorMessages.ZoomboxViewAlreadyInitialized, this.ViewKind.ToString() ) );
    ...
    public double Scale
    {
      ...
      {
                if (this.ViewKind != ZoomboxViewKind.Absolute)
                    throw new InvalidOperationException(ErrorMessages.ScaleOnlyAccessibleOnAbsolute);
        return _scaleWidth;
      }
      set
      {
    ...
    public Rect Region
    {
      get
      {
        ...
        if( _kindHeight < 0 )
          throw new InvalidOperationException( ErrorMessages.RegionOnlyAccessibleOnRegionalView );
