...
public class PackageManagerSettings : BasicSetting
{
    /// <summary>
    /// The folder path where packages are restored
    /// </summary>
    public string PackagesCacheFolderPath { get; set; }
    public List<PackageSourceSettingItem> PackageSources { get; set; } = new List<PackageSourceSettingItem>();
}

public class PackageSourceSettingItem
{
