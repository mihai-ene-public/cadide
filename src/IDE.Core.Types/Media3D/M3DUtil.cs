...
namespace IDE.Core.Types.Media3D
{
    internal static class M3DUtil
    {
        ...
        //       not modified.
        //
        internal static XPoint3D Interpolate(ref XPoint3D v0, ref XPoint3D v1, ref XPoint3D v2, ref XPoint barycentric)
        {
            double v = barycentric.X;
            double w = barycentric.Y;
            double u = 1 - v - w;

            return new XPoint3D(u * v0.X + v * v1.X + w * v2.X,
...
//        private static void AddPointToBounds(ref XPoint3D point, ref Rect3D bounds)
//        {
...
//        }
        ...
        //    if (positions != null)
        //    {
        //        FrugalStructList<XPoint3D> points = positions._collection;
        ...
        //    XPoint3D[] points = new XPoint3D[] {
        //        new XPoint3D(x1, y1, z1),
        //        new XPoint3D(x1, y1, z2),
        //        new XPoint3D(x1, y2, z1),
        //        new XPoint3D(x1, y2, z2),
        //        new XPoint3D(x2, y1, z1),
        //        new XPoint3D(x2, y1, z2),
        //        new XPoint3D(x2, y2, z1),
        //        new XPoint3D(x2, y2, z2),
        //    };
        ...
        internal static double GetAspectRatio(XSize viewSize)
        {
            return viewSize.Width / viewSize.Height;
        }

        // Normalizes the point in the given size to the range [-1, 1].
        internal static XPoint GetNormalizedPoint(XPoint point, XSize size)
        {
            return new XPoint(
        ...
        /// </summary>
        internal static XMatrix3D GetHomogeneousToViewportTransform3D(XRect viewport)
        {
        ...
        /// </summary>
        internal static XMatrix GetHomogeneousToViewportTransform(XRect viewport)
        {
            double sx = viewport.Width / 2; // half viewport width
            double sy = viewport.Height / 2; // half viewport height
            double tx = viewport.X + sx;
        ...
        internal static bool IsPointInTriangle(XPoint p, XPoint[] triUVVertices, XPoint3D[] tri3DVertices, out XPoint3D inters3DPoint)
        {
            double denom = 0.0;
            inters3DPoint = new XPoint3D();
            ...
            inters3DPoint = (XPoint3D)(lambda1 * (XVector3D)tri3DVertices[0] +
                                      lambda2 * (XVector3D)tri3DVertices[1] +
                                      (1.0f - lambda1 - lambda2) * (XVector3D)tri3DVertices[2]);
