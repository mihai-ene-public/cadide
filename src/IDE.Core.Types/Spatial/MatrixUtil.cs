    ...
    internal static class MatrixUtil
    {
        ...
        internal static void TransformRect(ref XRect rect, ref XMatrix matrix)
        {
            ...
            if (matrixType == MatrixTypes.TRANSFORM_IS_UNKNOWN)
            {
                ...
                XPoint point0 = matrix.Transform(rect.TopLeft);
                XPoint point1 = matrix.Transform(rect.TopRight);
                XPoint point2 = matrix.Transform(rect.BottomRight);
                XPoint point3 = matrix.Transform(rect.BottomLeft);
