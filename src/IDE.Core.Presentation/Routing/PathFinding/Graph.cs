...
namespace IDE.Core.Routing.PathFinding
{
    /// <summary>
    ...
    public class Graph
    {
        ...
        public Arc AddArc(Node StartNode, Node EndNode, int direction)
        {
        ...
        public void Add2Arcs(Node Node1, Node Node2)
        {
            AddArc(Node1, Node2, -1);
            AddArc(Node2, Node1, -1);
        }
