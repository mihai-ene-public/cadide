      ...
      //  Bitmap MMGrid = null;
        ...
        public List<PolyLine> GenerateNegativePolygon(double offsetinMM = 3, double retractMM = 1)
        {
            ...
            foreach (var b in TheSet.Instances)
            {
                ...
                cp.AddPaths(CombinedInstanceOutline, PolyType.ptSubject);
                cp.AddPaths(clips, PolyType.ptClip);
            ...
            foreach (var b in CombinedInstanceOutline)
            {
                ...
                Clipper cp = new Clipper();
                cp.AddPaths(BoardMinusCombinedInstanceOutline, PolyType.ptSubject);
                //cp.AddPaths(clips2, PolyType.ptClip);
