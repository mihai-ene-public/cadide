...
{
    public class ECapParametricPackageMeshItem : ParametricPackageMeshItem
    {
        public ECapParametricPackageMeshItem() 
        {
        ...
        {
            var generator = new ECapPackageGenerator
            {
                D = D,
                A = A,
                D1 = D1,
        ...
        protected override void LoadFromPrimitiveInternal(IPrimitive primitive)
        {
            try
            {
                ...
                var r = primitive as ECapParametricPackage3DItem;
        ...
        {
            var r = new ECapParametricPackage3DItem();
