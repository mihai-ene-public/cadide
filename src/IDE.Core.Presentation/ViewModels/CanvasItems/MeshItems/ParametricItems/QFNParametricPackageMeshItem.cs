...
{
    public class QFNParametricPackageMeshItem : ParametricPackageMeshItem
    {
        public QFNParametricPackageMeshItem() 
        {
        ...
        {
            var generator = new QFNPackageGenerator
            {
                D = D,
                A = A,
                E = E,
        ...
        protected override void LoadFromPrimitiveInternal(IPrimitive primitive)
        {
            try
            {
                ...
                var r = primitive as QFNParametricPackage3DItem;
        ...
        {
            var r = new QFNParametricPackage3DItem();
