...
{
    public class DIPParametricPackageMeshItem : ParametricPackageMeshItem
    {
        public DIPParametricPackageMeshItem()
        {
        ...
        {
            var generator = new DIPPackageGenerator
            {
                D = D,
                D1 = D1,
                A = A,
        ...
        protected override void LoadFromPrimitiveInternal(IPrimitive primitive)
        {
            try
            {
                ...
                var r = primitive as DIPParametricPackage3DItem;
        ...
        {
            var r = new DIPParametricPackage3DItem();
