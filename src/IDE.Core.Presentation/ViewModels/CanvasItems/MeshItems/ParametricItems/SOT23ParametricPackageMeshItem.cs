...
{
    public class SOT23ParametricPackageMeshItem : ParametricPackageMeshItem
    {
        public SOT23ParametricPackageMeshItem() 
        {
        ...
        {
            var generator = new SOT23PackageGenerator
            {
                D = D,
                E1 = E1,
                A = A,
        ...
        protected override void LoadFromPrimitiveInternal(IPrimitive primitive)
        {
            try
            {
                ...
                var r = primitive as SOT23ParametricPackage3DItem;
        ...
        {
            var r = new SOT23ParametricPackage3DItem();
