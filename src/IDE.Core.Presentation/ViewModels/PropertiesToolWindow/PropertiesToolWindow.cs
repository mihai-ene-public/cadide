...
{
    public class PropertiesToolWindowViewModel : ToolViewModel, IRegisterable
    {
    ...
    //public class NameValuePair : BaseViewModel
    //{
    //    string name;
    //    public string Name
    //    {
    ...
    //public class MScontainerHelper: ObjectContainerHelperBase
    //{
                                            ...
                                            , INotifyPropertyChanged
    {
        ...
        public ObjectPropertyDescriptor(MemberDescriptor descriptor, object owner)
            : base(descriptor)
        {
            Owner = owner;
        ...
        {
            return originalDescriptor.GetHashCode();
        }
