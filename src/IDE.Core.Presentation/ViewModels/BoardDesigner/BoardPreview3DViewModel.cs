...
public class BoardPreview3DViewModel : PreviewEditCanvasViewModel
{
    public BoardPreview3DViewModel(IDirtyMarkerTypePropertiesMapper dirtyMarkerTypePropertiesMapper)
        : base(dirtyMarkerTypePropertiesMapper)
    {
    }
